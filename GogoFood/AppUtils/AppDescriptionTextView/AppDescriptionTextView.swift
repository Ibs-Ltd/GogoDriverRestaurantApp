...
class AppDescriptionTextView: BaseAppView, UITextViewDelegate {
    ...
    @IBOutlet weak var lbl_dec: UILabel!
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        self.lbl_dec.text = "Descripton".localized()
        self.textView.text = AppStrings.enterDescription.localized()
   ...
   internal func textViewDidBeginEditing(_ textView: UITextView) {
    if textView.text == AppStrings.enterDescription.localized() {
            textView.text = ""
        }
    }
   ...
   internal func textViewDidEndEditing(_ textView: UITextView) {
        if textView.text == "" {
            textView.text = AppStrings.enterDescription.localized()
        }
    }
