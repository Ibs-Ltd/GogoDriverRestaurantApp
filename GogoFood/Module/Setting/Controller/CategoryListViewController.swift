...
class CategoryListViewController: BaseTableViewController<CategoryData> {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        createNavigationLeftButton(NavigationTitleString.listCategory.localized())
        createNavigationRightButton()
        // Do any additional setup after loading the view.
    }
    
    func createNavigationRightButton() {
        let b = UIBarButtonItem(title: "ADD".localized(), style: .plain, target: self, action: #selector(onAddCategory))
