...
class TabbarViewController: UITabBarController, UITabBarControllerDelegate {
    ...
    private let home = UITabBarItem(title: NavigationTitleString.home, image: #imageLiteral(resourceName: "home_unselected"), selectedImage: nil)
    private let inviteAndEarn = UITabBarItem(title: NavigationTitleString.inviteAndEarn, image: #imageLiteral(resourceName: "referEarn_unselected"), selectedImage: nil)
    private let history = UITabBarItem(title: NavigationTitleString.history, image: #imageLiteral(resourceName: "history_unselected"), selectedImage: nil)
    private let notification = UITabBarItem(title: NavigationTitleString.notification, image: #imageLiteral(resourceName: "notification_unselected"), selectedImage: nil)
    private let setting = UITabBarItem(title: NavigationTitleString.setting.localized(), image: #imageLiteral(resourceName: "setting_unselected"), selectedImage: nil)
    private let liveOrder = UITabBarItem(title: NavigationTitleString.liveOrder.localized(), image: #imageLiteral(resourceName: "liveOrder"), selectedImage: nil)
    ...
    private let restaurantHistory = UITabBarItem(title: NavigationTitleString.history.localized(), image: #imageLiteral(resourceName: "hisoryRestaurant"), selectedImage: nil)
    private let feed = UITabBarItem(title: NavigationTitleString.feed.localized(), image: #imageLiteral(resourceName: "feed"), selectedImage: nil)
    ...
    func setTabForUser() {
        ...
        self.viewControllers?[2].tabBarItem = self.history
